...
import org.mypetproject.userservice.domain.exception.AccessDeniedException;
import org.mypetproject.userservice.entities.user.UserRecipe;
import org.mypetproject.userservice.props.JwtProperties;
...
public class JwtTokenProvider {
    ...
    public JwtResponse refreshUserTokens(final String refreshToken) {
        ...
        UserRecipe user = userService.getById(userId);
