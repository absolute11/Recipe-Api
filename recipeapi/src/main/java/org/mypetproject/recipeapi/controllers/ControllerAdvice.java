...
import org.mypetproject.recipeapi.domain.exception.ExceptionBody;
import org.mypetproject.recipeapi.domain.exception.MessageNotFoundException;
...
public class ControllerAdvice {
    ...
    public ExceptionBody handleRecipeNotFound(
            final RecipeNotFoundException e
    ) {
        return new ExceptionBody(e.getMessage());
    }

    @ExceptionHandler(RecipeParsingException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ExceptionBody handleRecipeParsingException(
            final RecipeParsingException e
    ) {
        return new ExceptionBody(e.getMessage());
    }
    ...
    @ResponseStatus(HttpStatus.NOT_FOUND)
    public ExceptionBody handleMessageNotFoundException(
